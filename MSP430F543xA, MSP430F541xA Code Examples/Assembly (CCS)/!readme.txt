...
msp430x54xA_adc12_08.asm        ADC12, Using A8 and A9 Ext Channels for Conversion
...
msp430x54xA_flashwrite_03.asm   Bank Erase from a Block while Executing Code from Another Block.
...
hal_pmm.c	       		Library used to set the core voltage level of the PMM 
hal_pmm.h			Header file for the library used to set the core voltage level of the PMM