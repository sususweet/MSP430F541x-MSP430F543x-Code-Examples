...
msp430x54xA_adc12_08.c        ADC12, Using A8 and A9 Ext Channels for Conversion
...
msp430x54xA_flashwrite_03.c   Bank Erase from a Block while Executing Code from Another Block.
...
msp430x54xA_PMM.c             Library used to set the core voltage level of the PMM 
msp430x54xA_PMM.h             Header file for the library used to set the core voltage level of the PMM
